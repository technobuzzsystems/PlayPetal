  ...
  return (
    <div className="w-full bg-[#FFFDF9] text-[#202124] min-h-screen py-8 font-sans">
      ...
      <section className="w-full px-3 sm:px-4 md:px-5 lg:px-6 mb-10">
        <div className="bg-[#D90429] rounded-3xl p-8 md:p-12 text-white relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-lg min-h-[220px]">
          ...
          <div className="z-10 flex gap-4 text-center">
            <div className="bg-white/10 backdrop-blur-xs p-4 rounded-2xl border border-white/20 shadow-xs min-w-[110px]">
              <div className="text-2xl font-black text-white">50K+</div>
              <div className="text-[11px] font-bold text-white/80">Happy Kids</div>
            </div>
            <div className="bg-white/10 backdrop-blur-xs p-4 rounded-2xl border border-white/20 shadow-xs min-w-[110px]">
              <div className="text-2xl font-black text-[#FFD43B]">4.9 ★</div>
              <div className="text-[11px] font-bold text-white/80">Avg. Rating</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-3 sm:px-4 md:px-5 lg:px-6 mb-16">
        {loading ? (
          <div className="text-center py-20 font-bold text-slate-400">Loading Best Sellers...</div>
        ) : filteredProducts.length === 0 ? (
          <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 shadow-sm max-w-lg mx-auto">
            <div className="text-6xl mb-4">🔥</div>
            <h3 className="text-xl font-black text-[#202124] mb-2">No Best Seller Products</h3>
              ...
              return (
                ...
                >
                  <div className="relative h-64 w-full bg-slate-50 p-6 flex items-center justify-center overflow-hidden">
                    ...
                    <span className="absolute top-4 left-4 bg-[#FF9800] text-white text-[10px] font-black px-2.5 py-1 rounded-full shadow-xs uppercase tracking-wider">
                      {p.badge}
                    </span>
...
export default function BestSellersPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#FFFDF9] p-8 text-center text-[#202124] font-bold">Loading Best Sellers...</div>}>
      <BestSellersInner />
    </Suspense>
  );
}
