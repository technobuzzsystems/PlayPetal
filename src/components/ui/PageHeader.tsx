  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
      <div className="min-w-0">
        ...
        <h1 className="text-xl sm:text-2xl font-black text-[#202124] tracking-tight leading-tight">{title}</h1>
        {description && <p className="text-xs sm:text-sm text-slate-500 mt-1 font-medium leading-relaxed">{description}</p>}
      </div>
      {actions && (
