...
import { Boxes, CheckCircle2, AlertTriangle, XCircle, History, Search, RefreshCw } from 'lucide-react';
import type { InventoryItem } from '../types';

export const Inventory: React.FC = () => {
  const { inventory, stockHistory, refreshProducts } = useAdmin();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl border border-slate-200/80 p-4 flex items-center gap-3.5 shadow-2xs">
          <div className="w-11 h-11 rounded-xl bg-pink-50 text-indigo-600 flex items-center justify-center">
