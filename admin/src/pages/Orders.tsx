      ...
      <Card>
        ...
        <div className="p-4 sm:p-5 border-b border-slate-100 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
            {/* Status filter */}
            <div className="flex-1 min-w-[140px] sm:flex-initial flex items-center gap-1.5 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-600">
            ...
            {/* Payment filter */}
            <div className="flex-1 min-w-[130px] sm:flex-initial bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-600">
              <select
                value={paymentFilter}
                onChange={(e) => {
