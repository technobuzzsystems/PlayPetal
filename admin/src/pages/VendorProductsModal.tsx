...
export const VendorProductsModal: React.FC<VendorProductsModalProps> = ({
  ...
  const fetchVendorProducts = async () => {
    ...
    try {
      ...
      // Fallback directly to adminContext products
      ...
      footer={
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 w-full">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            <button
              onClick={onClose}
              className="flex-1 sm:flex-initial px-4 py-2 text-xs font-semibold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer text-center"
            >
              Close
            </button>
            <button
              ...
              className="flex-1 sm:flex-initial px-4 py-2 text-xs font-bold text-white bg-[#D90429] hover:bg-[#B7092B] rounded-xl shadow-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer"
            >
              <Plus size={14} />
    ...
    >
      <div className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pt-2">
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 p-1 rounded-xl border border-slate-200 w-full sm:w-auto overflow-x-auto max-w-full scrollbar-none shrink-0">
