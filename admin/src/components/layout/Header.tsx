      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {!isVendor && (
          <div className="relative" ref={notifRef}>
            ...
            {notificationsOpen && (
              <div className="absolute right-[-48px] sm:right-0 mt-2 w-[calc(100vw-2rem)] max-w-sm sm:w-96 rounded-2xl bg-white shadow-xl border border-slate-200 py-2 z-50 animate-in fade-in zoom-in-95 duration-100 text-[#202124]">
                {/* Header */}
